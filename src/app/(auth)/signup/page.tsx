...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!email || !password) {
      addToast('Please enter an email and password', 'warning');
      return;
    }
    ...
    if (res.success) {
      addToast('Account created successfully! Verification email logged to console.', 'success', 8000);
      ...
      <div className="container">
        <div className="auth-card glass animate-fade-in text-center">
          ...
          <p className="subtitle">
            ...
            For developer preview, the link has been logged directly to the server terminal. 
            Click it to activate your account!
          </p>
          <div className="action-row">
            <Link href="/login" className="btn inline-btn">
              Go to Login Page
            </Link>
          </div>
        </div>
  ...
  return (
    <div className="container">
      <div className="auth-card glass animate-fade-in">
        ...
        <p className="subtitle">Join CollabSpace and start collaborating instantly</p>
